Namespace MicrosoftOS
    ...
    Public Shared Function FlashWindow(ByRef handle As IntPtr, ByVal FlashTitleBar As Boolean,
                                       ByVal FlashTray As Boolean,
    ...
    Public Shared Function StopFlashWindow(ByRef handle As IntPtr) As Boolean
        If handle = Nothing Then Return False
        ...
        Try
            ...
            With fwi
                .hwnd = handle
                .dwFlags = FlashWindowFlags.FLASHW_STOP
                .dwTimeout = 0 ' Use the default cursor blink rate.
                .cbSize = CUInt(System.Runtime.InteropServices.Marshal.SizeOf(fwi))
            End With
