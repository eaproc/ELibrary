Imports EPRO.Library.v3._5.Types
...
#Region "Date Conversions between strings and date"
        ...
        Public Shared Function valueOf(ByVal obj As Object,
            ...
            Try
                If IsDBNull(obj) Then
                    Return Nothing
                Else
                    Return Microsoft.VisualBasic.Strings.Format(CDate(obj), DateFormats.valueOf(FormatNeeded))
                End If
            Catch ex As Exception
                Return Nothing
            End Try
        ...
        Public Shared Function valueOf(ByVal obj As Object,
            ...
            Try
                If IsDBNull(obj) Then
                    Return Nothing
                Else
                    Return Microsoft.VisualBasic.Strings.Format(CDate(obj), FormatNeeded)
                End If
            Catch ex As Exception
                Return Nothing
            End Try
        ...
        Public Shared Function valueOf(ByVal obj As NullableDateTime,
            ...
            Try
                ...
                Return Microsoft.VisualBasic.Strings.Format(obj.DateTimeValue, FormatNeeded)
...
#Region "Comparing DateTime"
        ...
        Public Shared Function EqualsTimeWithoutDate(pTime1 As Date, pTime2 As Date) As Boolean
            If IsNothing(pTime1) OrElse IsNothing(pTime2) Then Return False
        ...
        Public Shared Function EqualsDateWithoutTime(Date1 As Date, Date2 As Date) As Boolean
            If IsNothing(Date1) OrElse IsNothing(Date2) Then Return False
