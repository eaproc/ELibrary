Namespace Objects
    ...
    Public Class EStrings
        ...
        Public Shared Function CompareVersions(ByVal version1 As String, ByVal version2 As String) As Integer
            ...
            Dim SplittedV1() As String = Split(version1, "."), SplittedV2() As String = Split(version2, "."), SplittedTMP() As String
            ...
            For xIndex As Integer = 0 To SplittedV1.Count - 1
                ...
                If xIndex < SplittedV2.Count Then
                    ...
                    If Val(SplittedV1(xIndex)) > Val(SplittedV2(xIndex)) Then

                        Return 1 * isSwapped

                    ElseIf Val(SplittedV1(xIndex)) < Val(SplittedV2(xIndex)) Then
                ...
                ElseIf Val(SplittedV1(xIndex)) > 0 Then
        ...
        Public Shared Function splitWithoutNullElement(ByVal expression As String,
            ...
            Dim s_split() As String = Split(expression, delimiter)
        ...
        Public Shared Function ExtractStringFromHtml(ByVal HTMLString As String, ByVal startString As String,
            ...
            fLocate = InStr(CInt(locatePosition), HTMLString, startString, CompareMethod.Text)
            If fLocate <> 0 Then
                rLocate = InStr(CInt(fLocate), HTMLString, stopString, CompareMethod.Text)
...
errHandler:
        ...
        Public Shared Function CLEAN_UP_STRING(ByVal ORIGINAL_STRING As String) As String
            ...
            For byteCol = 0 To 31
                ORIGINAL_STRING = Replace(ORIGINAL_STRING, Chr(byteCol), "")
            ...
            CLEAN_UP_STRING = Replace(ORIGINAL_STRING, Chr(0), "")
        ...
        Public Shared Function Reverse_EncodeToFixLengthBytes(ByVal Str As String) As String
            ...
            Try
                For i = 0 To CShort(Len(Str) - 1) Step 3
                    ...
                    rtr_str &= Chr(EInt.valueOf(Str.Substring(i, 3)))
