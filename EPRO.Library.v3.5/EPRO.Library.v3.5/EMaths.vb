...
Public Class EMaths
    ...
    Public Shared Function Convert_Turkish_Decimal_to_Eng(ByVal xTurkishEntry As String) As String
        ...
        If xTurkishEntry.IndexOf(",") >= 0 Then
            ...
            Dim SplittedVal() As String = Split(xTurkishEntry, ",")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function getANumberBetween(ByVal x As Integer, ByVal y As Integer) As Integer
    ...
    Public Shared Function getCurrencyValue(ByVal strValue As String) As Double
        ...
        If IsNumeric(Left(strValue, 1)) Or Len(strValue) = 1 Then Return Val(strValue)


        Return Val(Right(strValue, Len(strValue) - 1))
    End Function
